...
return [
    ...
    */
    ...
    'logo_img_xl' => false,
    'logo_img_xs' => 'vendor/adminlte/dist/img/btec.png',
    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'icon'    => 'fas fa-fw fa-lg fa-bookmark',
            'submenu' => [
                [
        ...
        [
            'text'    => 'Manage classes',
            'icon'    => 'fas fa-fw fa-lg fa-layer-group',
            'submenu' => [
                [
                    'text' => 'List classes',
                    'icon'    => 'fas fa-fw fa-sm fa-list',
        ...
        [
            ...
            'icon'    => 'fas fa-fw fa-lg fa-location-arrow',
            'submenu' => [
                [
                    'text' => 'List locations',
                    'icon'    => 'fas fa-fw fa-sm fa-list',
