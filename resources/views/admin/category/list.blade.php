...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">
                <a href="{{ route('admin.categories.create') }}" class="text-success">
                ...
                <div class="row justify-content-end">
                    ...
                    <div class="col-2 mt-2">
                        <div class="form-group mb-0 pt-4">
                            <a href="{{route('admin.categories.index')}}" class="btn btn-block btn-default">Clear</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="card-footer clearfix">
            <ul class="pagination pagination-sm m-0 justify-content-center">
                {{ $categories->links('vendor.pagination.custom-basic-admin', ['params' => $params]) }}
            </ul>
        </div>
    </div>
@stop
